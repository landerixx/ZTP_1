        ...
        while (helper != 100) {
            ...
            switch (helper) {
                ...
                case 77:
                    ...
                    ISpecification ispec = new ExpressionSpecification<Student>(s -> s.getStudentName() == "Paweł");
                    ISpecification ispec2 = new ExpressionSpecification<Student>(s -> s.getStudentName() == "Piotr");
                    ispec2.and(ispec).not().or(ispec).isSatisfiedBy(new Student(1, "adam"));
                    break;
                default:
